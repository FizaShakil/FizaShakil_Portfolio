...
// const ProjectsHome = () => {
//   return (
//     <section className="min-h-screen bg-black text-white py-16 px-4 sm:px-6 lg:px-8" id='projectsHome'>
...
//                   <button className="px-5 py-2 text-sm font-medium text-gray-400 border border-gray-600 rounded-md transition-all duration-300 hover:text-gray-300 hover:border-gray-400 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-gray-500">
//                     Live Demo
//                   </button>
//                 </div>
//               </div>
